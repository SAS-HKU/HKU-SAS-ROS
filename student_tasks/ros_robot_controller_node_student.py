...
class RosRobotController(Node):
    ...
    def set_motor_state(self, msg):
        # STUDENT TODO: Convert a MotorsState ROS message into the list format
        # expected by Board.set_motor_speed(), then send it to the controller.
        # Expected list item format: [motor_id, rps].
        raise NotImplementedError('Complete set_motor_state')

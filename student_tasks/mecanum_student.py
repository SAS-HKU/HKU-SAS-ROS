...
class MecanumChassis:
    ...
    def speed_covert(self, speed):
        """
        Convert linear wheel speed in meters/second to wheel rotations/second.
        """
        # STUDENT TODO: One wheel rotation travels pi * wheel_diameter meters.
        raise NotImplementedError('Complete speed_covert')
    ...
    def set_velocity(self, linear_x, linear_y, angular_z):
        ...
        # STUDENT TODO: Compute the four mecanum wheel speeds from
        # linear_x, linear_y, and angular_z. Then convert each wheel speed
        # to rotations/second and package the result as a MotorsState message.
        # Motor ID order: 1, 2, 3, 4.
        raise NotImplementedError('Complete MecanumChassis.set_velocity')

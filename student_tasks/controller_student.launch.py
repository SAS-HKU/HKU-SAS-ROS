...
def launch_setup(context):
    ...
    if compiled == 'True':
        # STUDENT TODO: Use get_package_share_directory() to find the
        # installed paths for the peripherals and controller packages.
        raise NotImplementedError('Complete compiled package path lookup')
    else:
